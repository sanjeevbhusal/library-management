...
const takenBooksColumn: ColumnDef<Book>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return getRelativeDate(book.bookedDate);
    },
  },
  {
    accessorKey: "dueDate",
    ...
    cell: ({ row }) => {
      const book = row.original;
      return book.dueDate ? getRelativeDate(book.dueDate) : null;
    },
  },
  {
    id: "actions",
...
const returnedBooksColumn: ColumnDef<Book>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const book = row.original;
      return book.returnedDate ? getRelativeDate(book.returnedDate) : null;
    },
  },
  {
    id: "actions",
...
const uploadedBooksColumn: ColumnDef<Book>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const book = row.original;
      return book.uploadedAt ? getRelativeDate(book.uploadedAt) : null;
    },
  },
  {
    id: "actions",
...
export { takenBooksColumn, returnedBooksColumn, uploadedBooksColumn };
